...
{
    return (((if_id_curr->icode) == (I_ISUBQ)) ? (ex_mem_next->vale) : (
        (if_id_curr->icode) == (I_CALL) || (if_id_curr->icode) == (I_JMP))
...
long long gen_aluA()
{
    return (((id_ex_curr->icode) == (I_RRMOVQ) || (id_ex_curr->icode) == 
      ...
      (id_ex_curr->valb) : (((id_ex_curr->icode) == (I_ISUBQ)) & (
          (id_ex_curr->valb) >= 0)) ? (id_ex_curr->valc) : 0);
}
...
long long gen_aluB()
{
    return (((id_ex_curr->icode) == (I_RMMOVQ) || (id_ex_curr->icode) == 
       ...
       ? (id_ex_curr->valb) : ((id_ex_curr->icode) == (I_RRMOVQ) || 
        (id_ex_curr->icode) == (I_IRMOVQ)) ? 0 : (((id_ex_curr->icode) == 
          (I_ISUBQ)) & ((id_ex_curr->valb) >= 0)) ? (id_ex_curr->valb) : ((
          (id_ex_curr->icode) == (I_ISUBQ)) & ((id_ex_curr->valb) < 0)) ? 
      (id_ex_curr->valc) : 0);
}
