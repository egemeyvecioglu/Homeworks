...
## ID : 2449783
## I implemented isubq function as it will take the absolute value of rB and writes into rB
...
word aluA = [
	...
	E_icode == IISUBQ && E_valB < 0 :E_valB;
	E_icode== IISUBQ && E_valB >= 0 :E_valC;
