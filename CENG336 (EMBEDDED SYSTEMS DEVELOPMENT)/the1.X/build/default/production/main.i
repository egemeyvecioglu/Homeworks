...
main:
    ...
    movlw 00000111B ; light up ((PORTA) and 0FFh), 1, a, ((PORTA) and 0FFh), 2, a, ((PORTA) and 0FFh), 3, a
    movwf LATA
    call busy_wait
...
check_buttons:
    ...
    btfss curr_portb, 0 ; check ((PORTB) and 0FFh), 0, a
    call rb0_pressed

    btfss curr_portb, 1 ; check ((PORTB) and 0FFh), 1, a
    call rb1_pressed

    btfss curr_portb, 2 ; check ((PORTB) and 0FFh), 2, a
    call rb2_pressed

    btfss curr_portb, 3 ; check ((PORTB) and 0FFh), 3, a
    call rb3_pressed

    btfss curr_portb, 4 ; check ((PORTB) and 0FFh), 4, a
    call rb4_pressed
...
var2_overflown:
    ...
    btfsc WREG,0
    incf var4 ; var4 = new ((PORTA) and 0FFh), 0, a
