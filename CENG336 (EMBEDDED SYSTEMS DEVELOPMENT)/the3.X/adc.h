...
extern "C" {
    ...
    void initADC()
    {
        ...
        // The closest one to min Tad (8xTosc) hence Tad = 8xTosc = 0.8 us (ADCS2:ADCS0=?)
        ...
        ADCON2bits.ADCS2 = 0; // Tad (8xTOSC) -> 0.8us
        ADCON2bits.ADCS1 = 0; //change ADSC
        ADCON2bits.ADCS0 = 1;
